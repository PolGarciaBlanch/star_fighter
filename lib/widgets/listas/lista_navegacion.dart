    ...
    return Scaffold(
      ...
      body: isLoading
        ...
        child: CircularProgressIndicator(),
          ...
          : _ListBuilder(, lista), //body: CharacterListGen(),
    );
  }


  _ListBuilder(List<NavOpt> listNavOpt, String lista) {
    List<NavOpt> item = listNavOpt.where((i)=> i.lists.contains(lista)).toList();
    ...
    if (item.length > 0) {
      ListView.separated(
          ...
          itemBuilder: (BuildContext context, int index) {
            return GenericContainer(child: GenericContainer(child: Text(item[index].text[0],
